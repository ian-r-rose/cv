...
\Description{Rose, I. and Buffett, B.. \textit{Scaling for rates of true polar wander in convecting planets and moons}. Geophysical Journal International, in review.}

%------------------------------------------------

\Description{Rose, I. and Buffett, B.. \textit{Stability and accuracy of free surface time integration in viscous flows}. Physics of Earth and Planetary Interiors, in review.}
...
\Description{\MarginText{Languages} C, C++, Python, MATLAB/Octave, bash, awk, HTML}

\Description{\MarginText{Software} \LaTeX, vim, git, IPython notebooks, standard *nix tools}
